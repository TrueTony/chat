...
we arrive at a bae trivial case and then combining the result up the stack.

Assume we want to calculate the number of cooments of a particular post in
...
parser.add_argument('--id', type=int, default=8863,
    help='Id of the post in HN, default to 8863')
...
async def fetch(session, url):
    '''
    Fatch a URL using aiohttp returning parsed JSON respose
